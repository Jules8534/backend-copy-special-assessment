...
__author__ = "Julita, Sean Bailey, Chris Wilson"
__helped__ = "geeterista"


# git_special_paths(dir) --returns a list of the
...
# zip_to(path, zippath) given a list of paths,
...
def main():
    ...
    # If something is
    # wrong (or missing) with any
    # required args, the general
    # rule is to print a
